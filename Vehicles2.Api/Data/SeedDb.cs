    ...
    public class SeedDb
    {
        ...
        private async Task CheckDocumentTypesAsync()
        {
            if (!_context.DocumentTypes.Any())
            {
                ...
                _context.DocumentTypes.Add(new DocumentType { Description = "Libreta de Enrolamiento" });
                _context.DocumentTypes.Add(new DocumentType { Description = "Libreta de Cívica" });
        ...
        private async Task CheckBrandsAsync()
        {
            if (!_context.Brands.Any())
            {
                ...
                _context.Brands.Add(new Brand { Description = "Citroen" });
                ...
                _context.Brands.Add(new Brand { Description = "Peugeot" });
                _context.Brands.Add(new Brand { Description = "Volvo" });
        ...
        private async Task CheckVehiclesTypeAsync()
        {
            ...
            {
                _context.VehicleTypes.Add(new VehicleType { Description = "Automóvil" });
                _context.VehicleTypes.Add(new VehicleType { Description = "Moto" });
                _context.VehicleTypes.Add(new VehicleType { Description = "Camión" });
                _context.VehicleTypes.Add(new VehicleType { Description = "Camioneta" });
                _context.VehicleTypes.Add(new VehicleType { Description = "SUV" });
                _context.VehicleTypes.Add(new VehicleType { Description = "Cuadriciclo" });
                await _context.SaveChangesAsync();
            }
        }
    }
