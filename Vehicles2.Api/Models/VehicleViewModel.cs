...
namespace Vehicles2.Api.Models
{
    public class VehicleViewModel
    {
        ...
        [Display(Name = "Placa")]
        [RegularExpression(@"[a-zA-Z]{3}[0-9]{2}[a-zA-Z0-9]", ErrorMessage = "Formato de patente incorrecto.")]
        [Required(ErrorMessage = "El campo {0} es obligatorio.")]
        [StringLength(8, MinimumLength = 6, ErrorMessage = "El campo {0} debe tener entre  6 y 8 carácteres.")]
